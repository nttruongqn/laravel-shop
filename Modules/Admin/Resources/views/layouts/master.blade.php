...
<head>
    ...
    <link href="{{ asset('admin-template/css/main.css') }} " rel="stylesheet" />
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                     <div class="nav">
                        ...
                        <a class="{{ \Request::route()->getName() == 'admin.get.list.category' ? 'active' : '' }} nav-link"
                            href="{{ route('admin.get.list.category') }}">
                            <div class="sb-nav-link-icon"></div>
                            Danh mục
                        </a>
                        <a class="{{ \Request::route()->getName() == 'admin.get.list.product' ? 'active' : '' }} nav-link"
